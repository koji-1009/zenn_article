---
title: "FlutterのNavigatorとRouterのちがい"
emoji: "🔄"
...
非常に簡単な、説明のためのサンプルを用意しました。Navigator 1(`Navigator`)とNavigator 2(`Router`)の2つの実装で、ほぼ同じ機能を実現しています。^[GitHub Pagesの処理も適当なのは、ご容赦ください……]
