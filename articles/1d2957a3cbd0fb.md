...
# alias run:ios="build:ios; FLUTTER_ENGINE=\$FLUTTER_ENGINE_PATH flutter --local-engine=ios_debug_sim_unopt_arm64 --local-engine-host=host_debug_unopt_arm64 run"
# alias run:android="build:android; FLUTTER_ENGINE=\$FLUTTER_ENGINE_PATH flutter --local-engine=android_debug_unopt_arm64 --local-engine-host=host_debug_unopt_arm64 run"
# alias run:web="build:web; FLUTTER_ENGINE=\$FLUTTER_ENGINE_PATH flutter --local-web-sdk=wasm_release run -d chrome"
# alias run:serve="flutter run --web-hostname=localhost --web-port=8080 -d web-server"
# alias run:served="build:web; FLUTTER_ENGINE=\$FLUTTER_ENGINE_PATH flutter --local-web-sdk=wasm_release run --web-hostname=localhost --web-port=8080 -d web-server"
